...
from src.document_pipeline.schemas import DocumentMap, EvidenceChunk, ExtractedDocument, OutputPlan, OutputPlanSection
...
def write_output_plan(
    ...
    sections = [
        OutputPlanSection(
            ...
            source_chunk_ids=all_chunk_ids[:3],
        ...
        OutputPlanSection(
            ...
            title="Key Evidence",
            purpose="Surface the strongest extracted evidence chunks without inventing facts.",
            source_chunk_ids=all_chunk_ids[:8],
            max_chars=2200,
        ),
        OutputPlanSection(
